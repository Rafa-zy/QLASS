...
def train():
    ...
    if tokenizer.pad_token is None:
        # For Llama 3.2, we use a special token for padding
    ...
    rank0_print("training finished, saving states....")
    trainer.save_state()
    if trainer.is_deepspeed_enabled:
        rank0_print("training finished, saving models (deepspeed)....")
        trainer.save_model()
    else:
        rank0_print("training finished, saving models....")
